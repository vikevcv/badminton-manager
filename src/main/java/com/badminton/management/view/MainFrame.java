...
import com.badminton.management.controller.DashboardController;
...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Account account, Customer customer) {
    ...
    private void setupContentPanels() {
        ...
        int customerId;
        if (loggedInAccount.getRole() == Role.MEMBER && customer != null) {
            customerId = customer.getCustomerId();
        } else {
            customerId = -1; // admin không cần customer
        }
        ...
        if (loggedInAccount.getRole() == Role.ADMIN) {
            ...
            dashboardController = new com.badminton.management.controller.DashboardController(dashboardPanel);

            contentPanel.add(dashboardPanel, "DASHBOARD_MGR");
            ...
            cardLayout.show(contentPanel, "DASHBOARD_MGR");
        } else {
    ...
    private JPanel createSidebar() {
        ...
        if (loggedInAccount.getRole() == Role.ADMIN) {
            btnDashboard = createMenuButton("DashBoard", "DASHBOARD_MGR");
        ...
        btnLogout.addActionListener(e -> {
            this.dispose(); // Giải phóng (dispose) Frame hiện tại và quay về màn hình đăng nhập (khởi tạo
                            // lại AuthController).
    ...
    private JButton createMenuButton(String text, String cardName) {
        ...
        // if(cardName == "DASHBOARD_MGR")
        // btn.addActionListener(e -> dashboardController.refreshData());
        return btn;
    }
