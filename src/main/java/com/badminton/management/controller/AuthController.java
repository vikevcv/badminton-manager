...
public class AuthController {
    ...
    private void handleLogin() {
        ...
        if (loggedInAccount != null) {
            ...
            MainFrame mainFrame = new MainFrame(loggedInAccount);
    ...
    private void handleRegister() {
        ...
        registerView.addSubmitListener(e -> {
            ...
            if (result.equals("SUCCESS")) {
                registerView.showMessage("Đăng ký thành công! Bạn có thể đăng nhập ngay bây giờ.", "Thành công", JOptionPane.INFORMATION_MESSAGE);
                registerView.dispose();       // Đóng form đăng ký
                loginView.setVisible(true);   // HIỆN LẠI form đăng nhập
